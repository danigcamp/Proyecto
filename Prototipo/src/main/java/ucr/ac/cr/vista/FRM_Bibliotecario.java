...
public class FRM_Bibliotecario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        registroEstudiantes.setText("Registro Bibliotecareo");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Carnet", "Nombre", "Apellidos", "Celular", "Contrasena"
            }
        ));
    ...
    public void actualizarListaLibroATabla(Registro_Bibliotecario registro_Bibliotecario) {
        DefaultTableModel modeloTabla = (DefaultTableModel) jTable1.getModel();

        if (registro_Bibliotecario.getListaBibliotecario().isEmpty()) {
            modeloTabla.setRowCount(0); // Limpiar la tabla
        } else {
            modeloTabla.setRowCount(0); // Limpiar la tabla antes de agregar nuevos libros

            for (Bibliotecario bibliotecario : registro_Bibliotecario.getListaBibliotecario()) {
                Object[] fila = {
                    bibliotecario.getCarnet(),
                    bibliotecario.getNombre(),
                    bibliotecario.getApellidos(),
